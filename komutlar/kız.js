...
await member.setNickname(`${isim} | ${yas}`)
  member.roles.add("790634681447088129"); 
  member.roles.remove("790634606444675093");
  ...
  .setColor("RANDOM")
  .setTimestamp()
  .addField(`Kayıt İşlemi Başarılı`, `<@!${member.id}> **Adlı Kullanıcıya <@&790634681447088129> Rolünü Verdim ve İsmini** \n\`• ${isim} | ${yas}\` **Olarak Düzenledim**`) 
